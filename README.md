...
ProofRail is not a news site or an AI writer. Before a project page, blog post,
launch page, or report goes live, it renders a publication preview while an
...
| Tool | Mode | Purpose |
| --- | --- | --- |
| get_review_context | read | Return publication type, headline, body, claims, evidence graph, revisions, proposals, and gate |
| replace_review_packet | write | Load a project page, blog post, launch page, or report with exact headline/body claim spans |
...
- ProofRail stores source excerpts; it does not fetch a URL or certify that a
  source is true.
- The preview renders the exact headline and body in a simulated ProofRail
